...
plot_distribution("Case A",
                  simulate_distribution(step_coop_A, F, runs),
                  simulate_distribution(step_noncoop_A, F, runs))

print("Running Case B...")
plot_distribution("Case B",
                  simulate_distribution(step_coop_B, F, runs),
                  simulate_distribution(step_noncoop_B, F, runs))

print("Running Case C...")
plot_distribution("Case C",
                  simulate_distribution(step_coop_C, F, runs),
                  simulate_distribution(step_noncoop_C, F, runs))